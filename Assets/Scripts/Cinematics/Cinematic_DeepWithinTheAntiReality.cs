...
//
// 2. Attach this script (`Cinematic_.cs`)
...
/// </summary>
public class Cinematic_DeepWithinTheAntiReality : MonoBehaviour
{
    // ====================================================================
    //
     ...
     * Texture & Effects: Clean, Clear, and Articu lated. Subtle Digital/Synthetic Filter (low chorus).
    ...
    */
    ...
    void Start()
    {
        StartCoroutine(Cinematic_DeepWithinTheAntiReality_Sequence());
    }

    private IEnumerator Cinematic_DeepWithinTheAntiReality_Sequence()
    {
